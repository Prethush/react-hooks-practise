...
function EditUser(props) {
  ...
  return <>
    <form onSubmit={handleSubmit}>
      <input value={name} type="text" placeholder="Enter Name" data-id="name" onChange={handleChange} />
      <input value={username} type="text" placeholder="Enter Username" data-id="username" onChange={handleChange} />
